...
//          await controller.tap(`); // Launch the demo
...
//    }
    ...
    Finder fab = find.byTooltip('Increment');

    // Wait for the floating action button to appear
//    await driver.waitFor(fab);

    // Tap on the fab
//    controller.frameSync = false;
    await controller.tap(fab);

    // Wait for text to change to the desired value
//    await controller.waitFor(find.text('1'));
